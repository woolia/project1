...
nohup java -jar \
        -Dspring.config.location=classpath:/application.properties,classpath:/errors.properties,/home/ec2-user/app/application-oauth.properties,classpath:/application-real.properties \
